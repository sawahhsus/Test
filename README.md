...
![GitHub](https://img.shields.io/github/license/sawahhsus/Solar-Tweaks?style=for-the-badge)
![GitHub all releases](https://img.shields.io/github/downloads/sawahhsus/Solar-Tweaks/total?style=for-the-badge)
![GitHub package.json version](https://img.shields.io/github/package-json/v/sawahhsus/Solar-Tweaks?style=for-the-badge)
...
You can download the latest version of Solar Tweaks from the [GitHub releases page](https://github.com/sawahhsus/Solar-Tweaks/releases). You need to download the version corresponding to your operating system (OS). You can find a more in depth explanation on how to download [here](https://github.com/sawahhsus/Solar-Tweaks/wiki/Download-Solar-Tweaks)

If you want a complete tutorial about how to install Solar Tweaks for your specific operating system, More info on the installation process soon.
...
```bash
$ git clone https://github.com/sawahhsus/Solar-Tweaks.git
```
